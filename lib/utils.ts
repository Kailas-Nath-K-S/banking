...
export const authFormSchema=(type:string) => z.object({firstName:type==='sign-in' ? z.string().optional() :  z.string().min(1),
  ...
  dob:type==='sign-in' ? z.string().optional():  z.string().min(8),
